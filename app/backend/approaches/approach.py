...
class Approach(ABC):
    ...
    Args:
        ...
        openai_client (AsyncOpenAI): The OpenAI client used for embedding text or image queries.
        ...
        embedding_deployment (Optional[str]): The deployment name of the embedding model (not needed for non-Azure OpenAI or retrieval_mode="text").
...
class Approach(ABC):
    ...
    Args:
        search_client (SearchClient): The search client used for querying the search service.
